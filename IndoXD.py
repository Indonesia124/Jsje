# [+] Update INDOXD And All
# [+] Script Free Jangan Di Perjual Belikan Ya
# [+] Donasi Untuk INDO-XD 
# [+] Dana : 08999321112
...
for brayen in range(10000):
    ...
    u1 = f"Mozilla/5.0 (Linux; Android 5.1.1 {str(rr(4,12))}; SM-G5500 Build/LMY47X; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 {str(rr(0,4))} Chrome/{str(rr(73,150))}92.0.4515.166{str(rr(5500,5900))} {str(rr(75,150))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/328.0.0.22.119;]"
    u2 = f"Mozilla/5.0 (Linux; Android 6.0.1 {str(rr(4,12))}; SM-G532M Build/MMB29T; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 {str(rr(0,4))} Chrome/{str(rr(73,150))} 69.0.3497.100 {str(rr(5500,5900))} {str(rr(75,150))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/192.0.0.34.85;]"
    u3 = f"Mozilla/5.0 (iPhone; CPU iPhone OS 16_0 {str(rr(4,12))} {str(rr(1,9))}.{str(rr(1,9))} like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/{str(rr(73,150))}15E148 Instagram 265.0.0.13.302 {str(rr(5500,5900))}.{str(rr(75,150))} (iPhone10,6; iOS 16_0; it_IT; it-IT; scale=3.00; 1125x2436; 435784589)"
